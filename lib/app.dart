import 'package:datingapps/router.dart';
import 'package:flutter/material.dart';

class DatingApps extends StatefulWidget {
  @override
  _DatingAppsState createState() => _DatingAppsState();
}

class _DatingAppsState extends State<DatingApps> {
